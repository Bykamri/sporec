...
class App(ctk.CTk):
    ...
    def analyze_emotion(self):
        ...
        try:
            ...
            result = DeepFace.analyze(processed_frame, actions=[
                                      'emotion'], enforce_detection=True)
    ...
    def update_analysis_result(self, text):
        ...
        if "Emosi Anda: \n" in text:
            ...
            self.emotion_title_label.place(
                relx=0.6, rely=0.17, anchor="w")  # Changed from center to west anchor
            ...
            self.emotion_result_label.place(
                relx=0.6, rely=0.23, anchor="w")  # Changed from center to west anchor
        else:
        ...
        for i, (song, uri) in enumerate(songs_to_show):
            ...
            y_spacing = vertical_spacing + \
                (0.03 if frame_height > base_frame_height else 0)
        ...
        self.reset_button.place(relx=0.45, rely=0.2, anchor="center")
    ...
    def play_track(self, uri, index):
        try:
            ...
            self.now_playing_frame.place(relx=0.18, rely=0.65, anchor="center")
